...
@Form.create()
class AntdBasicFormDemo extends Component{
  ...
  render(){
    ...
    return(
      <div>
        <CustomBreadcrumb arr={['Antd','输入','基础表单']} />
...
export default AntdBasicFormDemo