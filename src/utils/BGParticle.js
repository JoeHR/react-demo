...
class BGparticle {
  ...
  createCanvas() {
    ...
    this.canvas.style.display = 'block'  // 防止全屏的 canvas 出现 滚动条
  ...
  handleMouseMove(e) {
    ...
    if (e.pageX || e.pageY) {
      ...
      posx = e.clientX + document.body.scrollLeft + document.dcocumentElement.scrollLeft
      posy = e.clicneY + document.body.scrollTop + document.documentElement.scrollTop
    }
    this.target.x = posx
    this.target.y = posy
  }
